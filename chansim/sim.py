...
from chansim.utils.ShapeGen import genCirc, genEll
#import time
...
class singleXC(sim):
    def __init__(self, init_radius=1., Q_w=1., slope=0.001, dt_erode=1., f=0.1,
        xc_n = 1500, trim=True, a=1., K=1e-5, layer_elevs = None):
    ...
    def erode(self):
        ...
        if not self.layered_sim:
            ...
            self.xc.erode_power_law_layered(a=self.a, K=self.K, 
                    layer_elevs = self.layer_elevs, dt=self.dt_erode)
